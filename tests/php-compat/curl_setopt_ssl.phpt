...
if ($curl_cffi_version['version_number'] < 0x074700) {
...
function check_error(CurlImpersonate\Curl $ch, $expected = null) {
    if (curl_cffi_errno($ch) !== 0) {
...
try {
    ...
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLCERT_BLOB, $clientCert));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLKEY_BLOB, $clientKey));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYPEER, false));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYHOST, false));
    ...
    $ch = curl_cffi_init("https://127.0.0.1:$port/");
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLCERT_BLOB, ''));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLKEY_BLOB, $clientKey));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYPEER, false));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYHOST, false));
    curl_cffi_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    $ch = curl_cffi_init("https://127.0.0.1:$port/");
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLCERT_BLOB, $clientCert));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLKEY_BLOB, ''));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYPEER, false));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYHOST, false));
    curl_cffi_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    $response = curl_cffi_exec($ch);
    check_response($response, $clientCertSubject);
    check_error($ch, curl_cffi_version()['version_number'] < 0x081000 ? 58 : 43);
    curl_cffi_close($ch);

    echo "\n";
    echo "case 4: client cert and key from file\n";
    $ch = curl_cffi_init("https://127.0.0.1:$port/");
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLCERT, $clientCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLKEY, $clientKeyPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYPEER, false));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYHOST, false));
    curl_cffi_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    $ch = curl_cffi_init("https://127.0.0.1:$port/");
    var_dump(curl_cffi_setopt($ch, CURLOPT_CAINFO, $serverCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_ISSUERCERT, $serverCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLCERT, $clientCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLKEY, $clientKeyPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYPEER, true));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYHOST, false));
    curl_cffi_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    $ch = curl_cffi_init("https://127.0.0.1:$port/");
    var_dump(curl_cffi_setopt($ch, CURLOPT_CAINFO, $serverCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_ISSUERCERT_BLOB, $serverCert));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLCERT, $clientCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLKEY, $clientKeyPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYPEER, true));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYHOST, false));
    ...
    $ch = curl_cffi_init("https://127.0.0.1:$port/");
    var_dump(curl_cffi_setopt($ch, CURLOPT_CAINFO, $serverCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_ISSUERCERT_BLOB, ''));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLCERT, $clientCertPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSLKEY, $clientKeyPath));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYPEER, true));
    var_dump(curl_cffi_setopt($ch, CURLOPT_SSL_VERIFYHOST, false));
