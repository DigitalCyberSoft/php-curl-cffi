--TEST--
Variation of bug #48203 with curl_cffi_multi_exec (Crash when file pointers passed to curl are closed before calling curl_cffi_multi_exec)
--EXTENSIONS--
curl_impersonate
--SKIPIF--
<?php
...
function checkForClosedFilePointer($target_url, $curl_option, $description) {
    ...
    curl_cffi_setopt_array($ch1, $options);
    curl_cffi_setopt_array($ch2, $options);
...
--EXPECTF--
Warning: curl_cffi_multi_add_handle(): CURLOPT_STDERR resource has gone away, resetting to stderr in %s on line %d
%A
Warning: curl_cffi_multi_add_handle(): CURLOPT_STDERR resource has gone away, resetting to stderr in %s on line %d
%A
Ok for CURLOPT_STDERR

Warning: curl_cffi_multi_add_handle(): CURLOPT_WRITEHEADER resource has gone away, resetting to default in %s on line %d

Warning: curl_cffi_multi_add_handle(): CURLOPT_WRITEHEADER resource has gone away, resetting to default in %s on line %d
Ok for CURLOPT_WRITEHEADER

Warning: curl_cffi_multi_add_handle(): CURLOPT_FILE resource has gone away, resetting to default in %s on line %d

Warning: curl_cffi_multi_add_handle(): CURLOPT_FILE resource has gone away, resetting to default in %s on line %d
%AOk for CURLOPT_FILE

Warning: curl_cffi_multi_add_handle(): CURLOPT_INFILE resource has gone away, resetting to default in %s on line %d
