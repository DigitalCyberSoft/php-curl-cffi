--TEST--
curl_cffi_copy_handle() allows to post CURLFile multiple times if postfields change
--EXTENSIONS--
curl_impersonate
--FILE--
<?php
...
$file = curl_cffi_file_create($filename);
$params = array('file' => $file);
var_dump(curl_cffi_setopt($ch2, CURLOPT_POSTFIELDS, $params));

$ch3 = curl_cffi_copy_handle($ch2);
