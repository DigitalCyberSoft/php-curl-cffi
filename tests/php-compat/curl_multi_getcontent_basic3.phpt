...
<?php
    ...
    curl_cffi_setopt($ch1, CURLOPT_URL, "{$host}/get.inc?test=getpost&get_param=Hello%20World");
    curl_cffi_setopt($ch2, CURLOPT_URL, "file://".__DIR__. DIRECTORY_SEPARATOR . "curl_testdata2.txt");
    ...
    $results1=curl_cffi_multi_getcontent($ch1);
        $results2=curl_cffi_multi_getcontent($ch2);
